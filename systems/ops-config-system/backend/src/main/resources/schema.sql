DROP TABLE IF EXISTS t_ops_system_control;
DROP TABLE IF EXISTS t_ops_routing_rule;
DROP TABLE IF EXISTS t_ops_channel_profile;
DROP TABLE IF EXISTS t_ops_cashier_template;
DROP TABLE IF EXISTS t_ops_payment_type;
DROP TABLE IF EXISTS t_ops_business_line;
DROP TABLE IF EXISTS t_ops_agreement_template;

CREATE TABLE t_ops_agreement_template (
...
CREATE TABLE t_ops_business_line (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE t_ops_payment_type (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE t_ops_cashier_template (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
    template_code VARCHAR(64) NOT NULL COMMENT '模板编码',
    template_name VARCHAR(128) NOT NULL COMMENT '模板名称',
...
CREATE TABLE t_ops_channel_profile (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE t_ops_routing_rule (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE t_ops_system_control (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
