...
export const paymentDayEndApi = {
  ...
  buildExportUrl: () => "/api/payment-day-end/export"
};
...
export const paymentTaskCenterApi = {
  ...
  buildExportUrl: ({
    ...
    return `/api/payment-task-center/task-runs/export?${params.toString()}`;
  },
  ...
  runReconcileIssueAlertReceipts: () => postJson("/api/payment-task-center/reconcile-issue-alert-receipts", {}),
...
export const paymentRequestApi = {
  getOverview: ({
    ...
    return request(`/api/payment-requests/overview?${params.toString()}`);
  },
  getList: ({
    requestNo = "",
    paymentOrderId = "",
...
export const paymentConfigApi = {
  ...
  toggleAlertProvider: (configCode, enabled) => postJson("/api/payment-config/alert-providers/toggle", { configCode, enabled }),
