    ...
    <section class="terminal-card entry-shell">
      ...
      <div class="entry-grid">
        ...
        <div class="entry-side">
          <div class="terminal-card entry-aside-card">
            <div class="section-heading">
              <div>
                <h3>接入检查清单</h3>
                <p>确保入口页和支付主链路在同一条业务线上收口。</p>
              </div>
            </div>
          ...
          <div class="terminal-card entry-aside-card">
            <div class="section-heading">
              <div>
                <h3>本次实现边界</h3>
                <p>先补齐入口拉起能力，后续再接账户、钱包和提现域的真实业务状态机。</p>
              </div>
            </div>
            <div class="ops-table">
              <div class="ops-row"><span>当前模式</span><span>虚拟业务单 + 统一收银台</span></div>
              <div class="ops-row"><span>风控治理</span><span>复用来源应用权限、幂等键、限流与渠道控制</span></div>
              <div class="ops-row"><span>后续增强</span><span>接入账户、钱包、提现、转账子系统真实单据</span></div>
            </div>
          </div>
        </div>
      </div>
