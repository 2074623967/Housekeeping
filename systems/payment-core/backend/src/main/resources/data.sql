...
INSERT INTO t_payment_alert_provider_config (provider_code, provider_name, channel_code, endpoint_alias, template_code, retry_policy, rate_limit_policy, status, status_type, updated_at) VALUES
('ALERT_IM_WECOM', '企业微信告警机器人', 'IM', 'wecom-bot-alerts', 'TPL_PAYMENT_ISSUE_IM_V1', '失败重试2次/间隔5分钟', '每分钟 60 条', 'ENABLED', 'success', '2026-07-24 12:10:00'),
('ALERT_SMS_TENCENT', '腾讯云短信告警', 'SMS', 'tencent-sms-alerts', 'TPL_PAYMENT_ISSUE_SMS_V1', '失败重试1次/间隔10分钟', '每分钟 30 条', 'ENABLED', 'success', '2026-07-24 12:10:00'),
('ALERT_EMAIL_SENDCLOUD', 'SendCloud 邮件告警', 'EMAIL', 'sendcloud-payment-alerts', 'TPL_PAYMENT_ISSUE_EMAIL_V1', '失败重试2次/间隔15分钟', '每分钟 20 封', 'ENABLED', 'success', '2026-07-24 12:10:00');
