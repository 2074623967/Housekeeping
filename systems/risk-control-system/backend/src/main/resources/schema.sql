DROP TABLE IF EXISTS t_risk_monitor_rule;
DROP TABLE IF EXISTS t_risk_review_order;
DROP TABLE IF EXISTS t_risk_intercept_event;
DROP TABLE IF EXISTS t_risk_blocklist;
DROP TABLE IF EXISTS t_risk_limit_rule;
DROP TABLE IF EXISTS t_risk_policy;
...
CREATE TABLE t_risk_limit_rule (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE t_risk_intercept_event (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE t_risk_review_order (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE t_risk_monitor_rule (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键',
