...
INSERT INTO t_wallet_account(
    ...
    'WA-USER-001', 'WO-USER-001', 'USER', '王阿姨', 'MAIN', 'USER_STORE', 'CNY',
...
INSERT INTO t_wallet_account(
    ...
    'WA-WORKER-001', 'WO-WORKER-001', 'WORKER', '李师傅', 'MAIN', 'WORKER_INCOME', 'CNY',
...
INSERT INTO t_wallet_flow(
    ...
    'WF-0001', 'WA-USER-001', 'OPEN_ACCOUNT', 'wallet-account', 'OPEN-WA-USER-001', 'OPEN-WA-USER-001',
...
INSERT INTO t_wallet_flow(
    ...
    'WF-0002', 'WA-USER-001', 'PENDING_IN', 'payment-core', 'PAY-RECHARGE-001', 'PENDING-IN-PAY-RECHARGE-001',
...
INSERT INTO t_wallet_flow(
    ...
    'WF-0003', 'WA-WORKER-001', 'FREEZE', 'wallet-withdraw', 'WD-LOCK-001', 'FREEZE-WD-LOCK-001',
