CREATE DATABASE IF NOT EXISTS housekeeping_settlement
  DEFAULT CHARACTER SET utf8mb4
  DEFAULT COLLATE utf8mb4_general_ci;

USE housekeeping_settlement;
...
CREATE TABLE `t_settlement_batch` (
  ...
  KEY `idx_settlement_batch_date` (`batch_date`),
  KEY `idx_settlement_batch_status` (`batch_status`)
...
CREATE TABLE `t_settlement_order` (
  ...
  KEY `idx_settlement_order_batch_no` (`batch_no`),
  KEY `idx_settlement_order_target_no` (`target_no`),
  KEY `idx_settlement_order_status` (`settlement_status`)
...
CREATE TABLE `t_settlement_item` (
  ...
  KEY `idx_settlement_item_settlement_no` (`settlement_no`)
...
CREATE TABLE `t_settlement_audit_log` (
  ...
  KEY `idx_settlement_audit_settlement_no` (`settlement_no`)
...
CREATE TABLE `t_payout_batch` (
  ...
  KEY `idx_payout_batch_batch_no` (`batch_no`),
  KEY `idx_payout_batch_status` (`payout_status`)
...
CREATE TABLE `t_payout_record` (
  ...
  KEY `idx_payout_record_batch_no` (`payout_batch_no`),
  KEY `idx_payout_record_settlement_no` (`settlement_no`)
...
CREATE TABLE `t_settlement_event` (
  ...
  KEY `idx_settlement_event_type` (`event_type`),
  KEY `idx_settlement_event_biz_no` (`biz_no`)
